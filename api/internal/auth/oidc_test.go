...
func TestHandleStart_SetsCookiesAndRedirects(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(context.Background(), "GET", "/auth/oidc/start", nil)
...
func TestHandleCallback_StateMismatch(t *testing.T) {
	...
	t.Run("no cookie", func(t *testing.T) {
		rr := httptest.NewRecorder()
		req := httptest.NewRequestWithContext(context.Background(), "GET", "/auth/oidc/callback?state=abc", nil)
