...
func TestMiddleware_Unauthenticated(t *testing.T) {
	...
	req := httptest.NewRequestWithContext(context.Background(), "GET", "/servers", nil)
	h.ServeHTTP(rr, req)
...
func TestMiddleware_DeniesViewerWrite(t *testing.T) {
	...
	rr := httptest.NewRecorder()
	req := httptest.NewRequestWithContext(context.Background(), "POST", "/servers", nil)
...
func TestMiddleware_OwnershipFallback_Owner(t *testing.T) {
	t.Run("owner allowed on :clone verb", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		req := httptest.NewRequestWithContext(context.Background(), "POST", "/servers/alpha:clone", nil)
	...
	t.Run("owner allowed on DELETE", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		req := httptest.NewRequestWithContext(context.Background(), "DELETE", "/servers/alpha", nil)
		user := &auth.User{ID: 1, Username: "alice"}
		req = req.WithContext(auth.WithUser(req.Context(), user))
		h.ServeHTTP(rr, req)
	...
	t.Run("owner allowed on :transfer", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		req := httptest.NewRequestWithContext(context.Background(), "POST", "/servers/alpha:transfer", nil)
		user := &auth.User{ID: 1, Username: "alice"}
		req = req.WithContext(auth.WithUser(req.Context(), user))
		h.ServeHTTP(rr, req)
	...
	t.Run("owner allowed on :wipe-data", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		req := httptest.NewRequestWithContext(context.Background(), "POST", "/servers/alpha:wipe-data", nil)
		user := &auth.User{ID: 1, Username: "alice"}
		req = req.WithContext(auth.WithUser(req.Context(), user))
		h.ServeHTTP(rr, req)
...
func TestMiddleware_OwnershipFallback_Collaborator(t *testing.T) {
	...
	t.Run("collaborator denied on :collaborators", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		req := httptest.NewRequestWithContext(context.Background(), "PUT", "/servers/alpha:collaborators", nil)
		user := &auth.User{ID: 2, Username: "bob"}
		req = req.WithContext(auth.WithUser(req.Context(), user))
		h.ServeHTTP(rr, req)
	...
	t.Run("collaborator allowed on :start", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		req := httptest.NewRequestWithContext(context.Background(), "POST", "/servers/alpha:start", nil)
		user := &auth.User{ID: 2, Username: "bob"}
		req = req.WithContext(auth.WithUser(req.Context(), user))
		h.ServeHTTP(rr, req)
...
func TestMiddleware_OwnershipFallback_InvalidPath(t *testing.T) {
	t.Run("invalid path with trailing segments after verb fails closed", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		req := httptest.NewRequestWithContext(context.Background(), "POST", "/servers/alpha:transfer/extra", nil)
		user := &auth.User{ID: 1, Username: "alice"}
		req = req.WithContext(auth.WithUser(req.Context(), user))
		h.ServeHTTP(rr, req)
...
func TestMiddleware_OwnershipFallback_FetchError(t *testing.T) {
	t.Run("fetch error fails closed", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		req := httptest.NewRequestWithContext(context.Background(), "GET", "/servers/alpha", nil)
		user := &auth.User{ID: 1, Username: "alice"}
		req = req.WithContext(auth.WithUser(req.Context(), user))
		h.ServeHTTP(rr, req)
...
func TestMiddleware_UnknownClusterRejected(t *testing.T) {
	...
	rr := httptest.NewRecorder()
	req := httptest.NewRequestWithContext(context.Background(), "GET", "/servers/alpha?cluster=ghost", nil)
