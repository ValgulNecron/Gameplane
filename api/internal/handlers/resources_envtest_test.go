...
func gvrServers() schema.GroupVersionResource {
	return schema.GroupVersionResource{Group: "kestrel.gg", Version: "v1alpha1", Resource: "gameservers"}
}

func gvrTemplates() schema.GroupVersionResource {
	return schema.GroupVersionResource{Group: "kestrel.gg", Version: "v1alpha1", Resource: "gametemplates"}
}
