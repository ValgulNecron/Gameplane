...
func TestComputeConditions(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(string(tc.phase), func(t *testing.T) {
			...
			conds := computeConditions(gs, tc.phase, nil, idleAwake, addressPlan{}, nil)
...
func TestComputeConditions_ProvisioningRefinement(t *testing.T) {
	...
	conds := computeConditions(gs, gameplanev1alpha1.GameServerPhaseStarting, prov, idleAwake, addressPlan{}, nil)
	...
	conds = computeConditions(gs, gameplanev1alpha1.GameServerPhaseStarting, nil, idleAwake, addressPlan{}, nil)
	for _, c := range conds {
...
func TestComputeConditions_FailedCarriesReason(t *testing.T) {
	...
	m := byType(computeConditions(gs, gameplanev1alpha1.GameServerPhaseFailed, prov, idleAwake, addressPlan{}, nil))
	...
	m = byType(computeConditions(gs, gameplanev1alpha1.GameServerPhaseFailed, nil, idleAwake, addressPlan{}, nil))
