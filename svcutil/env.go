...
// intended to reduce code duplication and enforce consistent startup and
// shutdown behavior across the Go binaries in this repo. It has no active
// consumers yet; see svcutil/specs.md for adoption status.
package svcutil
