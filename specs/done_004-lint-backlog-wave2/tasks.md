...
**Input**: Design documents from `/specs/done_004-lint-backlog-wave2/` (spec.md, plan.md, research.md, contracts/)
...
- [X] T077 Create `specs/done_004-lint-backlog-wave2/specs.md` consolidating the lint-gate contract with a maintainer verification recipe, or mark T064 done with a note that `contracts/lint-gate.md` satisfied the intent per T064 (missing)
