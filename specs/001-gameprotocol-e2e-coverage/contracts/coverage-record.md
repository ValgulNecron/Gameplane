...
| `factorio` | Factorio | blocked-doc | QUERY | TestGameServer_FactorioBot_Query | bot-fast | — | Wire format undocumented; server and client must match exactly (version-locked) | documentation |
